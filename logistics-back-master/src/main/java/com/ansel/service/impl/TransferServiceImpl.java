...
public class TransferServiceImpl implements ITransferService {
	...
	@Override
	public List<GoodsBill> transferGoods(String type) {
		// TODO Auto-generated method stub
		List<GoodsBill> list = goodsBillDao.transferState(type);
	...
	@Override
	public List<GoodsBill> arriveGoods(String type) {
		// TODO Auto-generated method stub
		List<GoodsBill> list = goodsBillDao.transferState(type);
		/*System.out.println(type+"000"+list.toString());
		List<GoodsBill> result = new LinkedList<>();
		//判断中转情况
		for (GoodsBill goodsBill : list) {
			String[] citys = goodsBill.getTransferStation().split(",");
